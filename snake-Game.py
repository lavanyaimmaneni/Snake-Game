...
def run_game():
    ...
    while not game_over:
        while game_close:
          ...
          game_display.blit(game_over_message, [width / 3, height / 2.5])
          game_over_message = message_font.render("Try Again!", True, white)
          game_display.blit(game_over_message, [width / 3, height / 2])
